        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    <div>
                        <button type="button" class="btn btn-scr btn-sm" style="margin-top: 10px" onclick="window.location.href='<?= base_url('admnwarehouse/scrap_to_return'); ?>'">Edit Status</button>
                    </div>
            </div>
        </div>
    </section>
