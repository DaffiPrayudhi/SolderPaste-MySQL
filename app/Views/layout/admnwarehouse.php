...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a href="<?php echo base_url('admnwarehouse/processing_form_warehouse'); ?>" class="nav-link" data-toggle="dropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="<?= base_url('admnwarehouse/profilewrhs'); ?>" class="dropdown-item">
        ...
        <aside class="main-sidebar sidebar-light-gray elevation-4">
            ...
            <span class="brand-link centered-image-link">
                <img id="brand-image" src="<?= base_url('assets/images/AVI.png'); ?>" style="width: 150px;">
                <img id="brand-text" src="<?= base_url('assets/images/AVI.png'); ?>" style="display: none; width: 60px;"></img>
            </span>
            <!-- Sidebar -->
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <span class="d-block text-dark"><b>Admin Warehouse</b></span>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admnwarehouse/dashboardwrhs'); ?>" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('admnwarehouse/warehouse_form'); ?>" class="nav-link">
                                        <i class="fas fa-qrcode nav-icon"></i>
                                        <p>Incoming</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('admnwarehouse/processing_form_warehouse'); ?>" class="nav-link">
                                        <i class="fas fa-sync-alt nav-icon"></i>
                                        <p>Proses</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('admnwarehouse/return_form'); ?>" class="nav-link">
    ...
    $(document).ready(function() {
        function fetchNotifications() {
            $.ajax({
                url: '<?= site_url('user/getNotifications'); ?>',
                type: 'GET',
                dataType: 'json',
                    ...
                    if(response.length > 0) {
                        ...
                        response.forEach(function(notification) {
                            $('#notification-list').append(
                                '<li><a href="processing_form_warehouse"> Solder Paste Conditioning - ' + notification.lot_number + ' - ' + notification.id + '</a></li>'
                            );
                        });
                    } else {
